...
public class PRISMEditorHelper : MonoBehaviour
{
    ...
    [MenuItem("Assets/Cinematic URP Post Processing - PRISM/Install Helper")]
    static void DoSomething()
    {
        ...
        if(data != null)
        {
            ...
            EditorUtility.DisplayDialog("CUPP Install Helper", "Please add all the CUPP effects you would like to use onto your renderer asset using 'Add Renderer Feature'", "OK");
        }
