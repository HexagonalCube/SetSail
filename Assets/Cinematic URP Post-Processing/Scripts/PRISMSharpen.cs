...
public class PRISMSharpen_URP : CustomPostProcessingPass<PRISMSharpen>
{
    ...
    protected override string RenderTag => "PRISM Sharpen";
    ...
    protected override void BeforeRender(CommandBuffer commandBuffer, ref RenderingData renderingData)
    {
        ...
        //Debug.LogWarning("SET INTENSITY");
    ...
    //init
    public PRISMSharpen_URP(RenderPassEvent renderPassEvent, Shader shader) : base(renderPassEvent, shader)
    {
        if (!m_Material)
        {
